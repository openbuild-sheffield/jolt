...
public class RequestCMSWordsAdd: OpenbuildExtensionPerfect.RequestProtocol {

    public var method: String
    public var uri: String
    public var description: String = "Add a CMS words item."
...
public let handlerRouteCMSWordsAdd = { (request: HTTPRequest, response: HTTPResponse) in
...
public class RouteCMSWordsAdd: OpenbuildRouteRegistry.FactoryRoute {
    ...
    override public func route() -> NamedRoute? {
        ...
        return NamedRoute(
            handlerRequest: RequestCMSWordsAdd(
                method: "post",
                uri: "/api/cms/words"
            ),
            handlerResponse: handlerResponse,
            handlerRoute: handlerRouteCMSWordsAdd
        )
    }
